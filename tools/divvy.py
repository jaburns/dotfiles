...
LAYOUTS = [
    ...
    [[     0, 0, 1.0/2, 1 ], [     0, 0, 1.0/3, 1 ], [     0, 0, 1.0/4, 1 ]], # m-h (far left)
    [[ 1.0/2, 0, 1.0/2, 1 ], [ 2.0/3, 0, 1.0/3, 1 ], [ 3.0/4, 0, 1.0/4, 1 ]], # m-l (far right)
    [[     0, 0, 3.0/4, 1 ], [     0, 0, 2.0/3, 1 ], [ 1.0/4, 0, 1.0/4, 1 ]], # m-j (middle left)
    [[ 1.0/4, 0, 3.0/4, 1 ], [ 1.0/3, 0, 2.0/3, 1 ], [ 1.0/2, 0, 1.0/4, 1 ]], # m-k (middle right)

    # Upper half
    [[     0, 0, 1,     0.5 ], [ 1.0/4, 0, 1.0/2, 0.5 ], [ 1.0/3, 0, 1.0/3, 0.5 ]], # m-n (maximized / middle)
    [[     0, 0, 1.0/2, 0.5 ], [     0, 0, 1.0/3, 0.5 ], [     0, 0, 1.0/4, 0.5 ]], # m-y (far left)
    [[ 1.0/2, 0, 1.0/2, 0.5 ], [ 2.0/3, 0, 1.0/3, 0.5 ], [ 3.0/4, 0, 1.0/4, 0.5 ]], # m-o (far right)
    [[     0, 0, 3.0/4, 0.5 ], [     0, 0, 2.0/3, 0.5 ], [ 1.0/4, 0, 1.0/4, 0.5 ]], # m-u (middle left)
    [[ 1.0/4, 0, 3.0/4, 0.5 ], [ 1.0/3, 0, 2.0/3, 0.5 ], [ 1.0/2, 0, 1.0/4, 0.5 ]], # m-i (middle right)

    # Lower half
    [[     0, 0.5, 1,     0.5 ], [ 1.0/4, 0.5, 1.0/2, 0.5 ], [ 1.0/3, 0.5, 1.0/3, 0.5 ]], # m-sh-n (maximized / middle)
    [[     0, 0.5, 1.0/2, 0.5 ], [     0, 0.5, 1.0/3, 0.5 ], [     0, 0.5, 1.0/4, 0.5 ]], # m-sh-y (far left)
    [[ 1.0/2, 0.5, 1.0/2, 0.5 ], [ 2.0/3, 0.5, 1.0/3, 0.5 ], [ 3.0/4, 0.5, 1.0/4, 0.5 ]], # m-sh-o (far right)
    [[     0, 0.5, 3.0/4, 0.5 ], [     0, 0.5, 2.0/3, 0.5 ], [ 1.0/4, 0.5, 1.0/4, 0.5 ]], # m-sh-u (middle left)
    [[ 1.0/4, 0.5, 3.0/4, 0.5 ], [ 1.0/3, 0.5, 2.0/3, 0.5 ], [ 1.0/2, 0.5, 1.0/4, 0.5 ]], # m-sh-i (middle right)
]
